...
public class Library {
    ...
    /auth_rename±nickname±login±password
    /auth_error
    /broadcast±msg
    ...
    **/
    ...
    public static final String AUTH_RENAME = "/auth_rename";
    ...
    public static String getAuthRename(String nickname, String login, String password) {
        return AUTH_RENAME + DELIMITER + nickname + DELIMITER + login + DELIMITER + password;
    }
